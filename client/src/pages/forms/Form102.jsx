...
import img from "/images/form102.png";
  ...
  return (
    <div className="border m-4 md:m-10 rounded-2xl p-4 md:!p-10 bg-white w-full  max-w-[900px] mx-auto text-sm md:text-base">
      ...
      <form onSubmit={handleSubmit} className="p-2 md:p-12 space-y-6">
        ...
        <div className="space-y-4">
          <p className="text-lg md:text-2xl  font-semibold">Witness Details</p>

          <div className="flex flex-col md:flex-row md:justify-between gap-4">
            <div className="flex flex-col w-full md:w-[47%]">
              <label className="mb-1 font-medium">
                Witness Name <span className="text-red-600">*</span>
              </label>
              <input
                type="text"
                name="witnessName"
            ...
            <div className="flex flex-col w-full md:w-[47%]">
              <label className="mb-1 font-medium">
                Witness Age <span className="text-red-600">*</span>
              </label>
              <input
                type="number"
                name="witnessAge"
          ...
          <div className="flex flex-col md:flex-row md:justify-between gap-4">
            <div className="flex flex-col w-full md:w-[47%]">
              <label className="mb-1 font-medium">
                Witness Address <span className="text-red-600">*</span>
              </label>
              <input
                type="text"
                name="witnessAddress"
          ...
          <div className="flex flex-col md:flex-row md:justify-between gap-4">
            <div className="flex flex-col w-full md:w-[47%]">
              <label className="mb-1 font-medium">
                Location of Swearing<span className="text-red-600">*</span>
              </label>
              <input
                type="text"
