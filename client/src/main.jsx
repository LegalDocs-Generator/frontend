...
import Main from "./pages/forms/Main.jsx";

const router = createBrowserRouter([
  {
    path: "/",
    element: <App />, // This can be your global wrapper (optional)
    children: [
      {
        index: true,
        element: <Home2 />,
...

      {
        ...
        element: <Main />,
        children: [
          { path: "form97", element: <Form97 /> },
          { path: "form98", element: <Form98 /> },
          { path: "form99", element: <Form99 /> },
          { path: "form100", element: <Form100 /> },
          { path: "form101", element: <Form101 /> },
          { path: "form102", element: <Form102 /> },
        ],
      },
